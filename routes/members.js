...
router.post("/send", async (req, res) => {
    try {
        ...
        const options = {
            ...
            //嵌入 html 的內文
            html: `<h2>親愛的會員您好：<br />感謝您註冊海軍商城會員<br/>請點擊下方連結完成電子信箱認證<br /><a href="http://localhost:3000/api/verify/${create_token}">請點這裡</a><br />不是您本人嗎?請直接忽略或刪除此信件，<br />如有問題請撥打客服專線0800-024-550，謝謝！</h2>`,
        };
